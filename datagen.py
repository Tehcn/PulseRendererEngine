block_data = [
	...
	},
	{
		...
		"blockstates":[
			{
				"name":"instrument",
				"values":["banjo","basedrum","bass","bell","bit","chime","cow_bell","didgeridoo","flute","guitar","harp","hat","iron_xylophone","pling","snare","xylophone"],
				"default":"harp"
			},
			{
				"name":"note",
	...
	},
	{
		...
		"blockstates":[
			{
				"name":"shape",
				"values":["east_west","north_east","north_south","north_west","south_east","south_west","ascending_east","ascending_north","ascending_south","ascending_west"],
				"default":"north_south"
			}
		]
	},
	...
	},
	{
		...
		"blockstates":[
			...
			{
				"name":"facing",
				"values":["north","east","south","up","west"],
				"default":"north"
			}
		]
	},
	...
	{
		"id":"smooth_sandstone_brick_stairs",
		"blockstates":[
			{
				"name":"facing",
				"values":["north","east","south","west"],
...
with open('src/blocktype.tmp.ts', 'a') as f:
    for block in block_data:
        f.write(f'typeof Blocks.{block["id"].upper()} | ')
